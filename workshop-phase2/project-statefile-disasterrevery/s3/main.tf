...
resource "aws_s3_bucket" "secondary" {
  provider = aws.south
  bucket   = "secondary2-terraform-statefilebucket"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:s3:::primary1-terraform-statefilebucket/*"
      },
      {
        Effect = "Allow"
        Action = [
        ...
        Resource = "arn:aws:s3:::secondary2-terraform-statefilebucket/*"
      }
    ]
  })
}
